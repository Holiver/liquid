...
class Filterbank
{
    ...
    public function invoke($name, $value, array $args = array()) {
        ...
        if (in_array($name, array("default"))) {
            $name = '_' . $name;
        }
        ...
        if (isset($this->methodMap[$name])) {
            ...
            if ($class === false) {
                ...
                $raw = call_user_func_array(array($class, $name), $args);

                if ($class instanceof I18nFilters) {
//                    $new_args = [];
...
//                            $document->parse($v);
//                            if (is_string($v)) {
//                                $raw[$k] = $document->render($args);
//                            }
//                        }
//                    } else {
//                        $document->parse($raw);
//                        $raw = $document->render($args);
//                    }
                }
