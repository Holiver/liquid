...
class Liquid
{
    ...
    public static $config = array(
        ...
        // Variable name with tag
        'TAG_VARIABLE_NAME' => '[a-zA-Z_\<][a-zA-Z_0-9.\-\[\]\/\>]*',
...
//                    return '/(' . self::$config['TAG_START'] . '[\s\S]*?' . self::$config['TAG_END'] . '|' . self::$config['VARIABLE_START'] . '[\s\S]*?' . self::$config['VARIABLE_END'] . ')/s';
